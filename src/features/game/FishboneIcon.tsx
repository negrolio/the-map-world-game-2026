...
export interface FishboneIconProps {
...
/**
 * Fish skeleton — "consolation prize" when a player got no correct answers.
 *
 * Silhouette path from game-icons.net ("Fishbone" by Lorc), licensed CC BY 3.0,
 * recolored to bone fill + chunky dark outline over a transparent background.
 * Attribution: see `src/assets/ASSET-CREDITS.md`.
 */
export function FishboneIcon({ className, title }: FishboneIconProps) {
  return (
    <svg
      viewBox="0 0 512 512"
      className={className}
